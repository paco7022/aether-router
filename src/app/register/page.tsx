...
export default function RegisterPage() {
    ...
    if (error) {
      ...
      if (refCodeRef.current) {
        await fetch("/api/v1/referral/redeem", {
          method: "POST",
          headers: { "Content-Type": "application/json", "X-Requested-With": "AetherRouter" },
          body: JSON.stringify({ code: refCodeRef.current, fingerprint }),
        }).catch(() => {});
  ...
  return (
    <div className="auth-shell">
      ...
      <div className="relative flex items-center justify-center px-6 py-12 lg:py-8 min-h-screen lg:min-h-0">
        ...
        <div className="w-full max-w-md relative z-10 animate-in">
          <div className="text-center mb-7 lg:hidden">
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 60px -8px rgba(139, 92, 246, 0.25)",
              }}
            >
              <span className="aurora-text">A</span>
            </div>
            <h1 className="text-2xl font-bold text-white/95 tracking-tight">Aether Router</h1>
          </div>
          ...
          {refCode && (
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(20, 184, 166, 0.08), rgba(34, 211, 238, 0.05))",
            ...
            >
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(94, 234, 212, 0.95)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            {error && (
              <div className="badge-error rounded-xl p-3 text-sm flex items-start gap-2">
            ...
            <div>
              <label className="block text-[10px] font-medium text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.15em]">Email</label>
              <input
                type="email"
                value={email}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-aurora px-4 py-3 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
